...
const ITEMS = [
  ...
  { img: IMG.event3, cat: "Events" },
  { img: IMG.event4, cat: "Events" },
  { img: IMG.gallery1, cat: "Rooms" },
  { img: IMG.fronter, cat: "Rooms" },
  { img: IMG.front, cat: "Rooms" },
  { img: IMG.lobby, cat: "Exterior" },
  { img: IMG.exterior2, cat: "Exterior" },
  { img: IMG.exterior3, cat: "Exterior" },
